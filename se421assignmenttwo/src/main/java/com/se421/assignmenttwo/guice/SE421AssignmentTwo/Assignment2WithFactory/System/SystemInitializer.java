...
import com.se421.assignmenttwo.guice.SE421AssignmentTwo.Assignment2WithFactory.Items.ItemFactory;
...
import com.se421.assignmenttwo.guice.SE421AssignmentTwo.Assignment2WithFactory.Printer.TablePrinter;
...
public class SystemInitializer implements LibrarySystemListener {
    ...
    private void readAdminInput() {
        ...
        while (true) {
            ...
            switch (itemTypeChoice) {
                case 1:
                    item = createItem(scanner, "book");
                    break;
                case 2:
                    item = createItem(scanner, "video");
                    break;
                case 3:
                    item = createItem(scanner, "journal");
                    break;
                case 4:
                    item = createItem(scanner, "technicalpaper");
                    break;
                default:
    ...
    private LibraryItem createItem(Scanner scanner, String itemType) {
        ...
        LibraryItem prototypeItem = new LibraryItem() {
            @Override
            public String getID() {
                return itemID;
            }
        ...
        // factory
        return ItemFactory.createItem(prototypeItem);
    }
}
